...
document.onmousemove = function(e) {
  ...
  x.push({
    type: 'float',
    value: parseFloat(e.clientX) || 0
  })
	var y = []
  y.push({
    type: 'float',
    value: parseFloat(e.clientY) || 0
  })
...
document.ontouchmove = function(e) {
  document.getElementById("OSCbaby").innerHTML = "Sending Touch X & Y: " + e.touches[0].clientX + " " + e.touches[0].clientY;
	//these emit under the tilt function
	x[0]=({
    type: 'float',
    value: parseFloat(e.touches[0].clientX) || 0
  })

  y[0]=({
    type: 'float',
    value: parseFloat(e.touches[0].clientY) || 0
  })
}
